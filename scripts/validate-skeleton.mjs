...
assert(view3Source.includes("view3-release-${film.film_id}") && view3Source.includes('class: `release-segment release-unit'), "View 3 release units must carry exact film identity");
assert(view3Source.includes("selectFilmById") && view3Source.includes("releaseNavigation"), "View 3 bidirectional film selection is missing");
...
assert(new Set([...expectedRivalryIds, ...laterRivalryIds]).size === 7, "View 2 timeline must contain exactly seven intended films");
